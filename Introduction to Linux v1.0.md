...
☞ To follow Teacher Chen's advice, this tutorial starts from the basics, and doesn't involve any third-party software. It means what we only have is terminal (However I still state an ssh software in the extra sections).![[assets/Linux/1 Hello Linux!/1.png]]
...
![[assets/Linux/1 Hello Linux!/2.png]]
## Why Linux
...
## Which Linux
![[assets/Linux/1 Hello Linux!/3.png]]
...
![[assets/Linux/11 Linux process commands/1.png]]
...
![[assets/Linux/11 Linux process commands/2.png]]
...
![[assets/Linux/11 Linux process commands/3.png]]
...
![[assets/Linux/11 Linux process commands/4.png]]
